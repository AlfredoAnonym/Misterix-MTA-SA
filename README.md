...
I don't condone you guys making scripts with AI - it sucks. Hire a scripter and he will do a 1000% better script than this. My dream was to play a way cooler version of misterix than Rhypasa made, because I felt some stuff were missing there, and script weren't updated that often. He only put AI guys around the map and I don't think he even put blips there so far I remember, and they had sooo much HP. I scripted few smaller scripts before for my own use (like a script, which permits people from certain countries to enter the server) on my own and let me tell you - learning scripting is much more fun than using an AI for it, you can use it to learn scripting and such, and attempt to do these kinds of projects by yourself. I also don't sell it, which to be honest - selling an AI script would be such a dogshit move. But if anyone else, dreamt about this kind of Misterix script (with a lot of features like this) this is for those people who just want to have fun and always wanted to try it and don't mind it being an AI script. With the help of AI I realized that vision, how a misterix script in my opinion should look like, because I'm not that experienced like some of the veterans here are. I hope, despite like 99% of the code being AI - you have fun playing this, or watching the vid for it privately. Call it an AI Slop, insult me or whatever - I'm still amazed that AI can pull off something like this. I don't think it's ready for major public use, but I have a server just in case you want to test it out, it's not open most of the times because it's a free server and we had played around for fun with my friend there:
