...
It should be played on Freeoram now. I planned to make it a separate gamemode, but I don't have a lot of help with it. I only script by myself, but most of the code is sadly AI (and I feel like I need to disclose that). I edited stuff myself too, and if you are a better scripter you can make this script a lot more better, and you can remake it even better than I did
